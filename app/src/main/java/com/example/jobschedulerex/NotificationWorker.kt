...
class NotificationWorker(private val context: Context, workerParameters: WorkerParameters) :
    ...
    override fun doWork(): Result {
        ...
        val launchPendingIntent = PendingIntent.getActivity(context, LAUNCHER_PENDING_INTENT_ID, launchIntent, PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        val workManagerPendingIntent = PendingIntent.getActivity(context, WORK_MANAGER_PENDING_INTENT_ID, workManagerIntent, PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        val pendingIntentPendingIntent = PendingIntent.getActivity(context, PENDING_INTENT_PENDING_INTENT_ID, pendingIntentIntent, PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        builder.apply {
            ...
            addAction(NotificationCompat.Action.Builder(
                ...
                workManagerPendingIntent).build())
